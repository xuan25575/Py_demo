...
def double_video(url, title, kaishi, jieshu):
    ...
    # 通过筛选得到每一集的集标题数据
    # 前缀r  在普通字符串中，反斜线是转义符，代表一些特殊的内容，如换行符\n，前缀r表示该字符串是原始字符串，即\不是转义符，只是单纯的一个符号。
...
def save_mp3_mp4(mp3_url, mp4_url, title):
    ...
    if len(title) == 2:
        ...
        path_create = fr'/Users/code/crawing/spider_demo/b站/bilibili/分集/{title01}/'
        path_generate = fr'/Users/code/crawing/spider_demo/b站/bilibili/分集/{title01}/{set_title}'
        ...
        path_create = fr'/Users/code/crawing/spider_demo/b站/bilibili/单集/{title}/'
        path_generate = fr'/Users/code/crawing/spider_demo/b站/bilibili/单集/{title}/{title}'
